...
{
    public class PartPinRound4x1 : Part
    {
        ...
        public override PartType PartType => (PartType)ExtraPartType.PartPinRound4x1;

        public override bool GeneratesDownforce => false;

        public override string TooltipText => "A larger type of pin";

        public override string PartName => "Pin x4";
        ...
        public override float Health => 4f;
        ...
        public PartPinRound4x1()
        {
            _importPart = ImportPart.FindImportPathByPartType("PartPinRound3x1");
        ...
        {
            Connectionpoint[] array = new Connectionpoint[4];
            ...
            array[0] = new ConnectorRoundPin(direction.Opposite(), direction.ToVector3() * 0f + pD.ToVector3() * 0f + pD2.ToVector3() * 0f);
            array[1] = new ConnectorRoundPin(direction, direction.ToVector3() * 1f + pD.ToVector3() * 0f + pD2.ToVector3() * 0f);
            array[2] = new ConnectorRoundPin(direction, direction.ToVector3() * 2f + pD.ToVector3() * 0f + pD2.ToVector3() * 0f);
            array[3] = new ConnectorRoundPin(direction, direction.ToVector3() * 3f + pD.ToVector3() * 0f + pD2.ToVector3() * 0f);
            return array;
        }
